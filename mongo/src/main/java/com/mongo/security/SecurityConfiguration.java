 ...
 * WebSecurityConfigurerAdapter { private UserPrincipalDetailsService
 * userPrincipalDetailsService; private UserRepository userRepository;
 * 
 * public SecurityConfiguration(UserPrincipalDetailsService
 ...
 * this.userRepository)) .authorizeRequests() // configure access rules
 * .antMatchers("/login").permitAll()
 * .antMatchers("/user/saveuser").hasRole("MANAGER")
 * .antMatchers("/user/getAllUsers").hasRole("MANAGER")
